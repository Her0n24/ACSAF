...
RAY_NORM_CONSANT_LWC = 0.5  # Max I_ray value for normalization in scoring 
LEVEL_CANDIDATE_MIN_M = 1000
LEVEL_CANDIDATE_STEP_M = 1000
OBSERVER_CLOUD_SLANT_ELEVATION_DEG = 75.0
MIN_OBSERVER_CLOUD_TRANSMITTANCE = 0.2
CLOUD_COVER_WEIGHT_PEAK = 0.6
CLOUD_COVER_WEIGHT_SIGMA_LEFT = 0.3
CLOUD_COVER_WEIGHT_SIGMA_RIGHT = 0.4
CLOUD_COVER_WEIGHT_PEAK_HEIGHT = 1.0
