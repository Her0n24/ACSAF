...
# Define and get the lat lon of the queued location
location = geolocator.geocode("Reading, England", language='en')
lat, lon = location.latitude, location.longitude

# print(location): print the name of the location

city = LocationInfo("Reading", "England", "London", lat, lon)  # Hong Kong
...
# get_cams_aod(today, run, city.name, today_str)
